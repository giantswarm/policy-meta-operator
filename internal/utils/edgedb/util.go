...
func InsertKyvernoClusterPolicy(ctx context.Context, client *edgedb.Client, name string, ruleNames []string, targetKinds []string, exempted bool) (KyvernoClusterPolicy, error) {
