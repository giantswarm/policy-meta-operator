...
require (
	...
	github.com/kyverno/api v0.0.1-alpha.3 // indirect
	...
	github.com/open-policy-agent/gatekeeper/v3 v3.17.2 // indirect
	...
	github.com/tektoncd/chains v0.23.1 // indirect
	...
	k8s.io/pod-security-admission v0.34.9 // indirect
...
replace github.com/sigstore/fulcio v1.6.5 => github.com/sigstore/fulcio v1.8.5
