...
replace github.com/containerd/containerd/v2 => github.com/containerd/containerd/v2 v2.4.1

replace github.com/containerd/containerd => github.com/containerd/containerd v1.7.36
...
replace github.com/sigstore/cosign/v3 => github.com/sigstore/cosign/v2 v3.1.3

replace github.com/sigstore/rekor => github.com/sigstore/rekor v1.5.4
...
replace go.opentelemetry.io/otel/exporters/otlp/otlpmetric/otlpmetrichttp => go.opentelemetry.io/otel/exporters/otlp/otlpmetric/otlpmetrichttp v1.46.0

replace go.opentelemetry.io/otel/exporters/otlp/otlptrace/otlptracehttp => go.opentelemetry.io/otel/exporters/otlp/otlptrace/otlptracehttp v1.46.0
